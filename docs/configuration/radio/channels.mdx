...
- Values in between indicate the number of bits of precision to be sent. In reality, there is a smaller practical range of values without giving excessively vague or precise locations, given in the table below.
